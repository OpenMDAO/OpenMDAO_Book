...
See [Specifying Units for Variables](core_features/working_with_components/units.ipynb#Specifying-Units-for-Variables) for details on how to specify units on OpenMDAO variables.
